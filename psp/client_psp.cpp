...
// vitaXash3D(fgsfdsfgs) export technology used
...
dllexport_t exports[] =
{
	...
	{ "IN_ClientMoveEvent", (void*)IN_ClientMoveEvent},
	{ "IN_ClientLookEvent", (void*)IN_ClientLookEvent},
	{ "__psp_free_heap", (void*)__psp_free_heap },
	{ NULL, NULL },
};
...
{
	__psp_free_heap(); //libc free heap
	return 0;
}
}
#endif //__PSP__